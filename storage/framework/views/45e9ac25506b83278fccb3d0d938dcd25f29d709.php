...
<div class="container mt-5">
	<div class="content_form row d-flex justify-content-around">
		<div class="col-7 bg-light border rounded">
			<h2 class="text-center my-4 text-info">Đăng nhập</h2>
			<form method="post" action="" class="p-3 border-top">
				<?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\Xampp\htdocs\project_laravel_test\resources\views/frontend/login.blade.php ENDPATH**/ ?>