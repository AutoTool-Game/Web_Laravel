...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <div class="col">
                                <a href="<?php echo e(route('redirectGoogle')); ?>">Đăng nhập bằng Google</a>
                            </div>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\project_laravel_test\resources\views/auth/login.blade.php ENDPATH**/ ?>