...
<head>
	...
	<!-- style css -->
	<link rel="stylesheet" type="text/css" href="{{ asset('admin/css/style_admin.css') }}">
...
<div class="container-fluid">
	<div class="row d-flex justify-content-between">
		<div class="col-2">
			<div class="row" style="background-color: #F8F9FA;">
				<div class="logo">
					<a href="index.php">
						<img src="{{ asset('admin/images/admin.png') }}" width="70" height="70">
				...
				<div>
					<div class="user mt-2" style="height: 50px;">
						<button class="btn_account">
							<img src="{{ asset('admin/images/xie.jpg') }}" alt="" width="100" height="30"> &nbsp; Admin 
	...
	<div class="row d-flex justify-content-between">
		<div class="menu col-2 p-0 bg-dark">
			...
			<ul>
				<li><a href="{{ url('admin/categories') }}"><i class="fa fa-th"></i> &nbsp; Danh mục sản phẩm</a></li>
				<li><a href="index.php?controller=products"><i class="fas fa-toolbox"></i> &nbsp; Sản phẩm</a></li>
				<li><a href="{{ url('admin/users') }}"><i class="fas fa-users"></i> &nbsp; Quản lý users</a></li>
				<li><a href="index.php?controller=orders"><i class="fas fa-luggage-cart"></i> &nbsp; Đơn hàng</a></li>
				<li><a href="{{ url('admin/news') }}"><i class="fas fa-newspaper"></i> &nbsp; Tin tức</a></li>
			</ul>
		</div>
